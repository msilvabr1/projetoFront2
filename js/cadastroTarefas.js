...
produto=api.then(res => res.clone().json()).then(json => {
  ...
  json.map(produto => {
    ...
    let card = `
      <div class="card2">
        <img src="https://msilvabr1.github.io/projetoFront2/assets/img_avatar2.png" alt="Avatar" style="width:100%">
    ...
    body.innerHTML += card;
      ...
      if(!produto.completed&&produto.id<=count){
        let card = `
        <div class="card2">
        <img src="https://msilvabr1.github.io/projetoFront2/assets/img_avatar.png" alt="Avatar" style="width:100%">
        <div class="container2">
          <h3>${produto.userId}</h3>
          <strong>${produto.id}</strong>
